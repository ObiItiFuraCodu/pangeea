...
public class Test_info_prof extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        backend.retrieve_test_data_proffesor(findViewById(R.id.support_lesson_list),e.getString("hour_milis"),findViewById(R.id.submission_list),findViewById(R.id.textView32));
    }
}