...
public class Hour_info_profesor extends AppCompatActivity {
   HourBackend connector = new HourBackend(this);
    ...
    protected void onStart() {
        ...
        connector.retrieve_hour_data_prof(e.getString("hour_milis"),findViewById(R.id.linear_1),findViewById(R.id.linear_2),findViewById(R.id.linear_3),findViewById(R.id.close_presence2));
    }
}